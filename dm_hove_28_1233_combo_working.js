...
myBoxShadow.forEach(function(hoveringId) {
  let hoveringName = document.getElementById(hoveringId);
  hoveringName.addEventListener("mouseover", function(hoverElements) {
console.log(hoveringId);
     self.onHovering = true;
     console.log(self.onHovering)
  });
  hoveringName.addEventListener("mouseout", function(hoverElements) {
console.log(hoveringId);
     self.onHovering = false;
     console.log(self.onHovering)
  });
...
let testingForHover = setInterval(() => {
function pageWork () {
  console.log(onHovering);
if (onHovering === true) {
